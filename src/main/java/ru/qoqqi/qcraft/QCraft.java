...
public class QCraft
{
    ...
    // Create a Deferred Register to hold CreativeModeTabs which will all be registered under the "q_craft" namespace
    ...
    // Creates a new food item with the id "q_craft:example_id", nutrition 1 and saturation 2
    public static final RegistryObject<Item> EXAMPLE_ITEM = ITEMS.register("example_item", () -> new Item(new Item.Properties().food(new FoodProperties.Builder()
            .alwaysEat().nutrition(1).saturationMod(2f).build())));

    // Creates a creative tab with the id "q_craft:example_tab" for the example item, that is placed after the combat tab
