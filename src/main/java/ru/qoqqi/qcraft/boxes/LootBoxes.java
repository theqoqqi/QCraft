...
public class LootBoxes {
	...
	public static final LootBox PUZZLE_BOX_EASY = create(
			new RandomUtils.WeightedEntry<>(1, new LootTableBoxEntry("puzzle_box_easy"))
	);
	
	public static final LootBox PUZZLE_BOX_NORMAL = create(
			new RandomUtils.WeightedEntry<>(1, new LootTableBoxEntry("puzzle_box_normal").withProcessor(new LootTableBoxEntry.UpgradeEnchantmentsProcessor(0, 1)))
	);
	
	public static final LootBox PUZZLE_BOX_HARD = create(
			new RandomUtils.WeightedEntry<>(1, new LootTableBoxEntry("puzzle_box_hard").withProcessor(new LootTableBoxEntry.UpgradeEnchantmentsProcessor(1, 2)))
	);
	...
	public static final LootBox PANDORAS_BOX = create(new CompositeBoxEntry(Arrays.asList(
			new RandomBoxEntry(RandomUtils.createWeightedList(
					new RandomUtils.WeightedEntry<>(1, new ExperienceBoxEntry(5000, 1000)),
					new RandomUtils.WeightedEntry<>(1, new StructureBoxEntry(new ResourceLocation(QCraft.MOD_ID, "end_portal"), new BlockPos(-2, 0, -2))),
					new RandomUtils.WeightedEntry<>(6, new LootTableBoxEntry("pandoras_box").withProcessor(new LootTableBoxEntry.UpgradeEnchantmentsProcessor(3, 7)))
			)),
			new RandomBoxEntry(RandomUtils.createWeightedList(
	...
	@SafeVarargs
	private static LootBox create(RandomUtils.WeightedEntry<IBoxEntry>... entries) {
		return new LootBox(RandomUtils.createWeightedList(entries));
	}
